...
export class MainJobComponent implements OnInit {
  ...
  constructor(private kanbanBoardService: KanbanBoardService, public dialog: MatDialog) {}
  ...
  onClickDeleteTask(indexMainJob: number, indexTask: number): void {
    const dialogRef = this.dialog.open(DialogDeleteConfirmComponent, {
      width: '250px',
